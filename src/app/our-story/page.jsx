...
export default function StoryPage() {
  return (
  <div className={`bg-[whitesmoke]/50 p-16 md:h-4/5 m-auto w-5/6 ${styles.story} text-xl leading-8 text-justify hyphens-auto`}>
      <div className=''>
        <h1 className='md:text-6xl text-2xl font-bold text-orange-300'>Nassy and Franc: A Story of Love</h1>
    <section>
...
<p>
They learned to lean on each other, realizing that their relationship was a source of strength. They celebrated small victories together and provided comfort during tough times, their bond growing stronger with each hurdle they overcame.
</p>
</section>
...
<h2>Epilogue: A Love That Lasts</h2>
<p>
On a sunny October afternoon, surrounded by family and friends, Franc and Nassy exchanged vows in a beautiful garden ceremony. Their eyes sparkled with joy and anticipation as they promised to support and cherish each other for the rest of their lives. The journey that began with a chance meeting had blossomed into a lifelong commitment, a love story that would inspire those around them.
</p>
