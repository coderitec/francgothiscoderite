...
export default function CountDown() {
  ...
  return (
    <div className="absolute h-screen  md:bg-[url(/gallery/us.jpg)] bg-[url(/gallery/mine.jpg)] bg-cover min-w-full text-center py-4">
      <ul className='flex md:flex-row flex-col md:items-center items-center py-5  md:justify-evenly justify-start pl-4 font-bold md:text-2xl text-lg bg-gray-200/80 shadow-2xl rounded-md md:w-3/5 m-auto md:h-[70vh] h-screen'>
